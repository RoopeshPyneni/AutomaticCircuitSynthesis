...
def update_circuit_parameters(circuit_parameters,circuit_parameters_slope,check_loss,optimization_input_parameters):
	...
	for param_name in circuit_parameters_slope:
		...
		if check_loss==-1:
			change=circuit_parameters_slope[param_name]['loss']*(circuit_parameters[param_name]**2)*alpha_parameters['common']*alpha_parameters[param_name]
		elif check_loss==1:
			change=circuit_parameters_slope[param_name]['loss_Io']*(circuit_parameters[param_name]**2)*alpha_parameters['common']*alpha_parameters[param_name]
		else:
