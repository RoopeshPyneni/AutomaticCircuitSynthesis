...
def calculate_initial_parameters(cir,optimization_input_parameters):
	...
	# Calculating Rb
	initial_circuit_parameters['Rb']=optimization_input_parameters['output_conditions']['Rs']

	# Calculating C1
	initial_circuit_parameters['C1']=calc_C1(opt_conditions,optimization_input_parameters)
	
	# Calculating Io
	initial_circuit_parameters['Io']=100e-6

	# Calculating W
	initial_circuit_parameters['W']=calc_W(initial_circuit_parameters,cir.mos_parameters)
	
	# Calculating Rd
	initial_circuit_parameters['Rd']=calc_Rd(opt_conditions)
	
	# Calculating C2 and Rbias
	initial_circuit_parameters['C2'],initial_circuit_parameters['Rbias']=calc_C2(cir.mos_parameters,opt_conditions,initial_circuit_parameters,optimization_input_parameters)
	
	# Calculating dc outputs
	dc_outputs=calc_dc_opt(initial_circuit_parameters,cir.mos_parameters,opt_conditions)
