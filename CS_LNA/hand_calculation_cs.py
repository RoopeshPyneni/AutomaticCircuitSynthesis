...
# Outputs : Ls,Rs
def calculate_Ls_Rs(rsource,cgs,gm,fo):
    Ls=rsource*cgs/gm
    Rs=calculate_resistance_inductor(Ls,fo)
    return Ls,Rs
...
def hand_calculations_cs(output_conditions,mos_parameters):
    ...
    circuit_parameters['Ls'],circuit_parameters['Rs']=calculate_Ls_Rs(Rs,cgs,gm,fo)
